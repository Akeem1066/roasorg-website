...
export default function PrivacyPolicy() {
  // Debug logging to verify the component is loading
  console.log('Privacy Policy page is loading...');
  
  return (
    <>
      <Head>
        <title>Privacy Policy - RoaSorg</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <meta name="description" content="Privacy Policy for RoaSorg applications and services" />
      ...
      <div className="container">
        <div className="policy-content">
          ...
          <p>
            RoaSorg ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our mobile applications, websites, and services.
          </p>
          ...
          <p>
            <strong>Our applications and services are not intended for children under 13 years of age.</strong> We do not knowingly collect personal information from children under 13. If you are a parent or guardian and believe your child has provided us with personal information, please contact us immediately.
          </p>
          <p>
            For users between 13 and 18 years of age, we recommend parental guidance and consent before using our services. We may collect limited information from users in this age range as necessary to provide our services.
          </p>
